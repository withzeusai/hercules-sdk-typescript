...
const fuse = new Fuse(
  [
    'client.iam.entry',
    'client.iam.scopes.archive',
    'client.iam.scopes.create',
    'client.iam.scopes.setDefaultRole',
    'client.iam.invitations.accept',
    'client.iam.invitations.create',
    'client.iam.invitations.createResource',
    'client.iam.invitations.listResource',
    'client.iam.invitations.revoke',
    'client.iam.roles.assign',
    'client.iam.roles.createOrgCustom',
    'client.iam.roles.listGrantable',
    'client.iam.roles.remove',
    'client.iam.roles.replace',
    'client.iam.roles.updatePermissions',
    'client.iam.userExceptions.get',
    'client.iam.userExceptions.set',
    'client.iam.resourceGrants.create',
    'client.iam.resourceGrants.replace',
    'client.iam.resourceGrants.revoke',
    'client.iam.resourceRules.replace',
    'client.iam.resourceRules.set',
    'client.iam.expiries.set',
    'client.iam.roleOverrides.get',
    'client.iam.roleOverrides.set',
    'client.iam.members.add',
    'client.iam.members.approve',
    'client.iam.members.remove',
    'client.iam.members.setStatus',
    'client.iam.admissionRules.archive',
    'client.iam.admissionRules.upsert',
    'client.iam.entryMode.set',
    'client.iam.groups.addMember',
    'client.iam.groups.archive',
    'client.iam.groups.create',
    'client.iam.groups.list',
    'client.iam.groups.removeMember',
    'client.iam.groups.rename',
