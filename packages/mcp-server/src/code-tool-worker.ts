...
const fuse = new Fuse(
  [
    ...
    'client.iam.tenants.members.assignResourceRole',
    'client.iam.tenants.members.assignRole',
    'client.iam.tenants.members.create',
    'client.iam.tenants.members.get',
    ...
    'client.iam.tenants.groups.assignResourceRole',
    'client.iam.tenants.groups.assignRole',
    'client.iam.tenants.groups.create',
    'client.iam.tenants.groups.delete',
    'client.iam.tenants.groups.get',
    'client.iam.tenants.groups.list',
    'client.iam.tenants.groups.listResourceRoleAssignments',
    'client.iam.tenants.groups.listRoleAssignments',
    'client.iam.tenants.groups.unarchive',
    'client.iam.tenants.groups.unassignResourceRole',
    'client.iam.tenants.groups.unassignRole',
    'client.iam.tenants.groups.update',
    'client.iam.tenants.groups.members.add',
    'client.iam.tenants.groups.members.list',
    'client.iam.tenants.groups.members.remove',
    'client.iam.tenants.roles.create',
    'client.iam.tenants.roles.delete',
    'client.iam.tenants.roles.get',
    ...
    'client.commerce.entitlements.create',
    'client.commerce.entitlements.get',
    'client.commerce.entitlements.list',
    'client.commerce.entitlements.update',
    ...
    'client.email.suppressions.batchAdd',
    'client.email.suppressions.batchRemove',
    'client.email.suppressions.create',
    'client.email.suppressions.delete',
    'client.email.suppressions.get',
