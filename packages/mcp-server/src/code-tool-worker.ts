...
const fuse = new Fuse(
  [
    ...
    'client.iam.tenants.accessRules.archive',
    'client.iam.tenants.accessRules.create',
    'client.iam.tenants.accessRules.list',
    'client.iam.tenants.accessRules.unarchive',
    'client.iam.tenants.accessRules.update',
    ...
    'client.iam.tenants.resources.createInvitation',
