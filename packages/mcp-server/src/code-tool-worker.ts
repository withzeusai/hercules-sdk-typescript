...
const fuse = new Fuse(
  [
    ...
    'client.iam.tenants.roles.evaluateGrantability',
    'client.iam.tenants.roles.listPermissionOverrides',
    'client.iam.tenants.roles.replacePermissionOverrides',
    ...
    'client.iam.tenants.invitations.create',
    'client.iam.tenants.invitations.list',
    'client.iam.tenants.invitations.revoke',
    'client.iam.tenants.resources.grants.create',
    'client.iam.tenants.resources.grants.replace',
    'client.iam.tenants.resources.permissionOverrides.replace',
