...
const fuse = new Fuse(
  [
    'client.beta.subscriptions.cancel',
    'client.beta.subscriptions.check',
    'client.beta.subscriptions.checkout',
    'client.beta.subscriptions.customers.billingPortal',
    'client.beta.subscriptions.customers.create',
    'client.beta.subscriptions.customers.delete',
    'client.beta.subscriptions.customers.get',
    'client.beta.subscriptions.customers.list',
    'client.beta.subscriptions.customers.update',
    'client.beta.subscriptions.plans.archive',
    'client.beta.subscriptions.plans.create',
    'client.beta.subscriptions.plans.get',
    'client.beta.subscriptions.plans.list',
    'client.beta.subscriptions.plans.update',
    'client.beta.subscriptions.plans.entitlements.attach',
    'client.beta.subscriptions.plans.entitlements.list',
    'client.beta.subscriptions.plans.entitlements.remove',
    'client.beta.subscriptions.entitlements.create',
    'client.beta.subscriptions.entitlements.get',
    'client.beta.subscriptions.entitlements.list',
    'client.beta.subscriptions.entitlements.update',
    'client.beta.subscriptions.coupons.create',
    'client.beta.subscriptions.coupons.delete',
