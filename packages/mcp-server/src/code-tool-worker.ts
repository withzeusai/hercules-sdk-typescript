...
const fuse = new Fuse(
  [
    ...
    'client.iam.tenants.grantableRoles',
    'client.iam.tenants.unarchive',
    'client.iam.tenants.update',
    'client.iam.tenants.grants.delete',
    'client.iam.tenants.grants.update',
    'client.iam.tenants.users.create',
    'client.iam.tenants.users.remove',
    'client.iam.tenants.users.update',
    'client.iam.tenants.users.permissionOverrides.get',
    'client.iam.tenants.users.permissionOverrides.update',
    'client.iam.tenants.groups.archive',
    'client.iam.tenants.groups.create',
    'client.iam.tenants.groups.unarchive',
    'client.iam.tenants.groups.update',
    'client.iam.tenants.groups.members.add',
    'client.iam.tenants.groups.members.remove',
    'client.iam.tenants.groups.permissionOverrides.get',
    'client.iam.tenants.groups.permissionOverrides.update',
    'client.iam.tenants.roles.archive',
    'client.iam.tenants.roles.create',
    'client.iam.tenants.roles.unarchive',
    'client.iam.tenants.roles.update',
    'client.iam.tenants.roles.permissionOverrides.get',
    'client.iam.tenants.roles.permissionOverrides.update',
    'client.iam.tenants.admissionRules.archive',
    'client.iam.tenants.admissionRules.create',
    'client.iam.tenants.admissionRules.list',
    'client.iam.tenants.admissionRules.unarchive',
    'client.iam.tenants.admissionRules.update',
    'client.iam.tenants.auditEvents.list',
    'client.iam.tenants.invitations.createResource',
    'client.iam.tenants.invitations.createTenant',
    'client.iam.tenants.invitations.list',
    'client.iam.tenants.invitations.revoke',
    'client.iam.tenants.resources.accessGrantingRoles',
    'client.iam.tenants.resources.grants.create',
    'client.iam.tenants.resources.grants.update',
    'client.iam.tenants.resources.permissionOverrides.update',
    ...
    'client.domains.purchased.confirm',
    'client.domains.purchased.create',
    'client.domains.purchased.get',
