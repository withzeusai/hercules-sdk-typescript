...
const fuse = new Fuse(
  [
    ...
    'client.accessControl.invitations.createResource',
    'client.accessControl.invitations.listResource',
    'client.accessControl.invitations.revoke',
    'client.accessControl.roles.assign',
    'client.accessControl.roles.createOrgCustom',
    'client.accessControl.roles.listGrantable',
    'client.accessControl.roles.remove',
    'client.accessControl.roles.replace',
    'client.accessControl.roles.updatePermissions',
    'client.accessControl.userExceptions.get',
    'client.accessControl.userExceptions.set',
    'client.accessControl.resourceGrants.create',
    'client.accessControl.resourceGrants.replace',
    'client.accessControl.resourceGrants.revoke',
    'client.accessControl.resourceRules.replace',
    'client.accessControl.resourceRules.set',
    'client.accessControl.expiries.set',
    'client.accessControl.roleOverrides.get',
    'client.accessControl.roleOverrides.set',
    'client.accessControl.members.add',
    'client.accessControl.members.approve',
    'client.accessControl.members.remove',
    'client.accessControl.members.setStatus',
    'client.accessControl.admissionRules.archive',
    'client.accessControl.admissionRules.upsert',
    'client.accessControl.entryMode.set',
    'client.accessControl.groups.addMember',
    'client.accessControl.groups.archive',
    'client.accessControl.groups.create',
    'client.accessControl.groups.list',
    'client.accessControl.groups.removeMember',
    'client.accessControl.groups.rename',
