...
export const sdkMethods: SdkMethod[] = [
  ...
  },
  {
    ...
    fullyQualifiedName: 'iam.tenants.grantableRoles',
    httpMethod: 'get',
    httpPath: '/v1/iam/tenants/{tenant_id}/grantable-roles',
  },
  {
  ...
  {
    clientCallName: 'client.iam.tenants.users.permissionOverrides.update',
    fullyQualifiedName: 'iam.tenants.users.permissionOverrides.update',
    httpMethod: 'patch',
    httpPath: '/v1/iam/tenants/{tenant_id}/users/{user_id}/permission-overrides',
  },
  {
    clientCallName: 'client.iam.tenants.users.permissionOverrides.get',
    fullyQualifiedName: 'iam.tenants.users.permissionOverrides.get',
    httpMethod: 'get',
    httpPath: '/v1/iam/tenants/{tenant_id}/users/{user_id}/permission-overrides',
  },
  {
  ...
  {
    clientCallName: 'client.iam.tenants.groups.permissionOverrides.update',
    fullyQualifiedName: 'iam.tenants.groups.permissionOverrides.update',
    httpMethod: 'patch',
    httpPath: '/v1/iam/tenants/{tenant_id}/groups/{group_id}/permission-overrides',
  },
  {
    clientCallName: 'client.iam.tenants.groups.permissionOverrides.get',
    fullyQualifiedName: 'iam.tenants.groups.permissionOverrides.get',
    httpMethod: 'get',
    httpPath: '/v1/iam/tenants/{tenant_id}/groups/{group_id}/permission-overrides',
  },
  {
  ...
  },
  {
    ...
    fullyQualifiedName: 'iam.tenants.roles.unarchive',
    httpMethod: 'post',
    httpPath: '/v1/iam/tenants/{tenant_id}/roles/{role_id}/unarchive',
  },
  {
    clientCallName: 'client.iam.tenants.roles.permissionOverrides.update',
    fullyQualifiedName: 'iam.tenants.roles.permissionOverrides.update',
    httpMethod: 'patch',
    httpPath: '/v1/iam/tenants/{tenant_id}/roles/{role_id}/permission-overrides',
  },
  {
    clientCallName: 'client.iam.tenants.roles.permissionOverrides.get',
    fullyQualifiedName: 'iam.tenants.roles.permissionOverrides.get',
    httpMethod: 'get',
    httpPath: '/v1/iam/tenants/{tenant_id}/roles/{role_id}/permission-overrides',
  },
  {
  ...
  {
    clientCallName: 'client.iam.tenants.accessRules.update',
    fullyQualifiedName: 'iam.tenants.accessRules.update',
    httpMethod: 'patch',
  ...
  },
  {
    ...
    fullyQualifiedName: 'iam.tenants.accessRules.unarchive',
    httpMethod: 'post',
    httpPath: '/v1/iam/tenants/{tenant_id}/access-rules/{rule_id}/unarchive',
  },
  {
  ...
  {
    clientCallName: 'client.iam.tenants.resources.accessGrantingRoles',
    fullyQualifiedName: 'iam.tenants.resources.accessGrantingRoles',
    httpMethod: 'get',
    httpPath: '/v1/iam/tenants/{tenant_id}/resources/{resource_type}/{resource_id}/access-granting-roles',
  },
  {
    clientCallName: 'client.iam.tenants.resources.createInvitation',
    fullyQualifiedName: 'iam.tenants.resources.createInvitation',
    httpMethod: 'post',
    httpPath: '/v1/iam/tenants/{tenant_id}/resources/{resource_type}/{resource_id}/invitations',
  },
  {
  ...
  {
    clientCallName: 'client.iam.tenants.resources.grants.update',
    fullyQualifiedName: 'iam.tenants.resources.grants.update',
    httpMethod: 'patch',
    httpPath: '/v1/iam/tenants/{tenant_id}/resources/{resource_type}/{resource_id}/grants',
  },
  {
    clientCallName: 'client.iam.tenants.resources.permissionOverrides.update',
    fullyQualifiedName: 'iam.tenants.resources.permissionOverrides.update',
    httpMethod: 'patch',
