...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.iam.tenants.admissionRules.unarchive',
    fullyQualifiedName: 'iam.tenants.admissionRules.unarchive',
    httpMethod: 'post',
    httpPath: '/v1/iam/tenants/{tenant_id}/admission-rules/{rule_id}/unarchive',
  },
  {
  ...
  {
    clientCallName: 'client.iam.tenants.invitations.createResource',
    fullyQualifiedName: 'iam.tenants.invitations.createResource',
    httpMethod: 'post',
    httpPath: '/v1/iam/tenants/{tenant_id}/resources/{resource_type}/{resource_id}/invitations',
  },
  {
    clientCallName: 'client.iam.tenants.invitations.createTenant',
    fullyQualifiedName: 'iam.tenants.invitations.createTenant',
    httpMethod: 'post',
    httpPath: '/v1/iam/tenants/{tenant_id}/invitations',
  },
  {
