...
export const metadata: Metadata = {
  ...
  operationId: 'getSubscriptionsV1Entitlements',
};

export const tool: Tool = {
  name: 'list_subscriptions_entitlements',
  description:
...
export const handler = async (client: Hercules, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.subscriptions.entitlements.list(body).asResponse();
  try {
