...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/subscriptions/v1/plans',
  operationId: 'postSubscriptionsV1Plans',
};

export const tool: Tool = {
  name: 'create_subscriptions_plans',
  description:
...
export const handler = async (client: Hercules, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.subscriptions.plans.create(body)));
  } catch (error) {
