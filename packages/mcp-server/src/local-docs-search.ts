...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "description": "Creates a checkout session for a customer to subscribe to a product. Returns a URL to redirect the customer to for payment. After successful payment, the customer is subscribed to the product and gains access to its entitlements.",
    ...
    "response": "{ id: string; action: 'checkout' | 'update'; mode?: 'subscription' | 'payment'; subscription?: { id: string; product_id: string; status: string; variant_id?: string; }; url?: string; }",
  ...
  },
  {
    ...
    "description": "Cancels a customer's subscription. By default, the subscription remains active until the end of the current billing period. Set cancellation_timing to 'immediate' to cancel immediately.",
    ...
    "response": "{ id: string; cancellation_timing: 'immediate' | 'at_billing_period_end'; status: string; canceled_at?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/cancel \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"customer_id\": \"cus_1234567890\",\n          \"subscription_id\": \"sub_1234567890\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Verifies if a customer has access to a specific feature. Use this to gate features in your app based on the customer's active subscription and the entitlements attached to their product. Hercules recommends calling this before allowing access to premium features.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/check \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"customer_id\": \"cus_1234567890\",\n          \"resource_id\": \"feat_1234567890\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Retrieves a paginated list of all customers. Customers are the billable entities in your app—typically users, organizations, or projects.",
    ...
    "response": "{ id: string; created: string; address?: { city?: string; country?: string; line1?: string; line2?: string; postal_code?: string; state?: string; }; email?: string; name?: string; phone?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/customers \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves a customer by ID. Returns the customer object including contact information and billing address.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/customers/$CUSTOMER_ID \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new billable customer. A customer represents the entity in your app that will be charged—typically a user, organization, or project. Hercules recommends creating a customer immediately after creating the corresponding entity in your app.",
  ...
  },
  {
    ...
    "description": "Updates an existing customer. Use this to modify contact information or billing address. Only provided fields are updated; omitted fields remain unchanged.",
  ...
  },
  {
    ...
    "description": "Generates a URL to a hosted billing portal where the customer can view invoices, update payment methods, and manage billing details. Redirect the customer to the returned URL.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/customers/$CUSTOMER_ID/billing_portal \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "description": "Retrieves a paginated list of subscription products. Products define the pricing and billing intervals for subscriptions. Each product can have resources attached that grant access to features or content.",
    ...
    "response": "{ id: string; active: boolean; created: string; name: string; subscription_group_id: string; description?: string; media?: { id: string; display_order: number; type: 'image' | 'video'; url: string; file_size?: number; filename?: string; thumbnail_url?: string; }[]; metadata?: object; resources?: { id: string; active: boolean; created: string; type: 'feature'; feature?: { id: string; metadata?: object; }; }[]; tags?: string[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/products \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "httpMethod": "get",
    "summary": "Get Product",
    "description": "Retrieves a product by ID. Returns the product object including pricing details and status.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/products/$PRODUCT_ID \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new subscription product with a recurring price. Common examples include Free, Pro, Business, or Teams tiers. After creating a product, attach resources to define which features or content customers on this product can access.",
    ...
    "response": "{ id: string; active: boolean; created: string; name: string; subscription_group_id: string; variants: { id: string; active: boolean; created: string; name: string; currency?: currency; description?: string; media?: object[]; metadata?: object; recurring?: object; unit_amount?: number; }[]; description?: string; media?: { id: string; display_order: number; type: 'image' | 'video'; url: string; file_size?: number; filename?: string; thumbnail_url?: string; }[]; metadata?: object; resources?: { id: string; active: boolean; created: string; type: 'feature'; feature?: { id: string; metadata?: object; }; }[]; tags?: string[]; }",
  ...
  },
  {
    ...
    "description": "Updates an existing product. Use this to modify the product name, description, or active status. Pricing cannot be changed after creation—create a new product instead.",
  ...
  },
  {
    ...
    "description": "Retrieves all resources attached to a product. Resources define the entitlements customers gain access to when purchasing this product.",
    ...
    "response": "{ id: string; active: boolean; created: string; type: 'feature'; feature?: { id: string; metadata?: object; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/products/$PRODUCT_ID/resources \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Attaches one or more resources to a product. Customers who purchase this product will gain access to the attached resources. Resource type is inferred from the ID prefix (e.g., 'feat_' for features).",
    ...
    "response": "{ data: { id: string; active: boolean; created: string; type: 'feature'; feature?: { id: string; metadata?: object; }; }[]; }",
  ...
  },
  {
    ...
    "description": "Detaches one or more resources from a product. Customers will lose access to these resources when they purchase this product.",
  ...
  },
  {
    ...
    "description": "Retrieves all variants for a product. Variants represent different pricing tiers or configurations (e.g., Basic, Pro, Enterprise) within a single product.",
    ...
    "response": "{ id: string; active: boolean; created: string; name: string; currency?: string; description?: string; media?: { id: string; display_order: number; type: 'image' | 'video'; url: string; file_size?: number; filename?: string; thumbnail_url?: string; }[]; metadata?: object; recurring?: { interval: 'day' | 'week' | 'month' | 'year'; interval_count?: number; }; unit_amount?: number; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/products/$PRODUCT_ID/variants \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves a variant by ID. Returns the variant object including pricing details and status.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/products/$PRODUCT_ID/variants/$VARIANT_ID \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new variant with pricing for a product. Use variants to offer multiple pricing tiers or configurations (e.g., Basic at $10/month, Pro at $25/month). A Stripe Price is automatically created.",
  ...
  },
  {
    ...
    "description": "Updates an existing variant. Use this to modify the name, description, or active status. Pricing cannot be changed after creation—create a new variant instead.",
  ...
  },
  {
    ...
    "description": "Retrieves a paginated list of all coupons. Coupons provide discounts that customers can apply during checkout using a promo code.",
    ...
    "response": "{ id: string; active: boolean; code: string; created: string; duration: 'once' | 'repeating' | 'forever'; times_redeemed: number; amount_off?: number; currency?: string; duration_in_months?: number; max_redemptions?: number; name?: string; percent_off?: number; redeem_by?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/coupons \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "httpMethod": "get",
    "summary": "Get Coupon",
    "description": "Retrieves a coupon by ID. Returns the coupon object including discount details and redemption statistics.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/coupons/$COUPON_ID \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a discount coupon with a promo code. Coupons can offer percentage or fixed-amount discounts and can be limited by redemption count or expiration date. Customers can apply coupons during checkout.",
  ...
  },
  {
    ...
    "description": "Updates an existing coupon. Use this to modify the display name or deactivate the coupon. Discount amounts and codes cannot be changed after creation.",
  ...
  },
  {
    ...
    "description": "Retrieves a paginated list of features. Features are reusable entitlements that can be attached to multiple products.",
    ...
    "response": "{ id: string; active: boolean; created: string; description: string; name: string; metadata?: object; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/features \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/commerce/features/$FEATURE_ID \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new feature with a lookup key. Features can be attached to multiple products to grant customers access to the same entitlement across different subscription tiers.",
  ...
  },
  {
    ...
    "description": "Retrieves a paginated list of content collections. Content collections define the schema/structure for content entries.",
    ...
    "response": "{ id: string; api_id: string; created: string; locked: boolean; name: string; updated: string; version: number; description?: string; fields?: { id: string; api_id: string; created: string; name: string; type: string; description?: string; display_order?: number; localized?: boolean; validation?: object; }[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/collections \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves a content collection by ID. Returns the collection object including all field definitions.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/collections/$COLLECTION_ID \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new content collection with optional initial fields. Content collections define the schema for entries. Example collections: 'Blog Post', 'Product', 'Author'.",
  ...
  },
  {
    ...
    "description": "Updates an existing content collection. Use this to modify the name, description, or lock status. The api_id cannot be changed after creation.",
  ...
  },
  {
    ...
    "description": "Archives a content collection, hiding it from the API. Existing entries are preserved. Use this instead of deletion to maintain data integrity.",
  ...
  },
  {
    ...
    "description": "Adds a new field to a content collection. Fields define the structure of entries. The collection must not be locked. Adding a field increments the collection version.",
    ...
    "response": "{ id: string; api_id: string; created: string; name: string; type: string; description?: string; display_order?: number; localized?: boolean; validation?: { allowed_collections?: string[]; allowed_mime_types?: string[]; allowed_values?: string[]; array_item_type?: string; default_value?: object; max?: number; min?: number; pattern?: string; required?: boolean; unique?: boolean; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/collections/$COLLECTION_ID/fields \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"api_id\": \"nXI\",\n          \"name\": \"name\",\n          \"type\": \"text\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Updates an existing field in a content collection. The field type cannot be changed after creation. The collection must not be locked.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/collections/$COLLECTION_ID/fields/$FIELD_ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "description": "Removes a field from a content collection. Existing entry data for this field is preserved but will no longer be validated. The collection must not be locked.",
  ...
  },
  {
    ...
    "description": "Retrieves a paginated list of content entries. Supports filtering by collection, status, locale, and custom field queries. Use the 'where' parameter for field-based filtering with operators like $eq, $contains, $gt, etc.",
    ...
    "response": "{ id: string; collection_id: string; created: string; fields: object; status: 'draft' | 'published' | 'archived'; updated: string; version: number; collection_api_id?: string; first_published_at?: string; published_at?: string; scheduled_publish_at?: string; scheduled_unpublish_at?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/entries \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves a content entry by ID. Optionally specify a locale to get localized field values with fallback resolution.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/entries/$ENTRY_ID \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new content entry for a given collection. Entries start as drafts by default. Use the publish endpoint to make entries publicly accessible.",
  ...
  },
  {
    ...
    "description": "Updates an existing content entry. Supports partial updates - only specified fields are modified. Use the version parameter for optimistic locking to prevent concurrent update conflicts.",
  ...
  },
  {
    ...
    "description": "Archives a content entry, hiding it from the API and public access. The entry data is preserved and can be restored later.",
  ...
  },
  {
    ...
    "description": "Publishes a content entry, making it publicly accessible. Optionally schedule publishing for a future time. Publishing validates that all required fields have values.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/entries/$ENTRY_ID/publish \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "description": "Unpublishes a content entry, reverting it to draft status. The entry will no longer be publicly accessible but all data is preserved.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/entries/$ENTRY_ID/unpublish \\\n    -X POST \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves a paginated list of content assets (images, videos, documents, etc.). Supports filtering by status, MIME type, folder, and search.",
    ...
    "response": "{ id: string; created: string; filename: string; folder: string; mime_type: string; size: number; status: 'draft' | 'published'; updated: string; description?: string; height?: number; metadata?: object; published_at?: string; title?: string; url?: string; width?: number; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/assets \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/assets/$ASSET_ID \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new content asset with metadata. For now, this creates asset metadata only - provide a URL for an externally hosted file. Full upload support coming soon.",
  ...
  },
  {
    ...
    "description": "Permanently deletes a content asset. This action cannot be undone. Entries referencing this asset will have broken references.",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/assets/$ASSET_ID/publish \\\n    -X POST \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves a list of configured locales. Locales define the languages available for content localization.",
    ...
    "response": "{ id: string; active: boolean; code: string; created: string; is_default: boolean; name: string; fallback_locale?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/locales \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/locales/$LOCALE_CODE \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new locale for content localization. Configure fallback chains by setting the fallback_locale to another locale code.",
  ...
  },
  {
    ...
    "description": "Updates a locale's configuration including name, fallback, default status, and active status.",
  ...
  },
  {
    ...
    "description": "Deletes a locale. The default locale cannot be deleted - set another locale as default first. Existing localized content is preserved.",
  ...
  },
  {
    ...
    "description": "Retrieves a paginated list of releases. Releases group entries and assets for atomic publishing.",
    ...
    "response": "{ id: string; created: string; name: string; status: 'draft' | 'scheduled' | 'published' | 'failed'; updated: string; description?: string; error_message?: string; items?: { id: string; action: 'publish' | 'unpublish'; item_id: string; type: 'entry' | 'asset'; }[]; published_at?: string; scheduled_at?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/releases \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/releases/$RELEASE_ID \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new release. Add items using the add items endpoint, then publish or schedule the release.",
  ...
  },
  {
    ...
    "description": "Publishes all items in the release immediately. Each item's action (publish or unpublish) is executed atomically.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/releases/$RELEASE_ID/publish \\\n    -X POST \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Schedules a release for future publication. The release will be automatically published at the specified time.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/releases/$RELEASE_ID/schedule \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"scheduled_at\": \"2019-12-27T18:11:19.117Z\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Adds an entry or asset to a release with a specified action (publish or unpublish). Only draft releases can have items added.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/releases/$RELEASE_ID/items \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"item_id\": \"item_id\",\n          \"type\": \"entry\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/content/releases/$RELEASE_ID/items/$ITEM_ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves a paginated list of custom domains linked to the website, including Cloudflare verification and SSL status.",
    ...
    "response": "{ id: string; created: string; hostname: string; updated: string; wildcard: boolean; ssl_status?: string; status?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/domains \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/email \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"from\": \"x\",\n          \"subject\": \"x\",\n          \"to\": \"dev@stainless.com\"\n        }'"
      }
    }
  },
  {
    ...
    "httpMethod": "get",
    "summary": "List Emails",
    "description": "Retrieves a paginated list of sent emails. Returns email metadata including delivery status.",
    ...
    "response": "{ id: string; created_at: string; from: string; subject: string; to: string[]; bcc?: string[]; cc?: string[]; last_event?: 'sent' | 'delivered' | 'opened' | 'clicked' | 'bounced' | 'complained'; reply_to?: string[]; }",
  ...
  },
  {
    ...
    "response": "{ id: string; created_at: string; from: string; subject: string; to: string[]; bcc?: string[]; cc?: string[]; html?: string; last_event?: 'sent' | 'delivered' | 'opened' | 'clicked' | 'bounced' | 'complained'; reply_to?: string[]; text?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/email/$EMAIL_ID \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new sender identity for email verification. For email identities, a verification email is sent. For domain identities, DNS records are returned that must be configured to verify ownership.",
    ...
    "response": "{ id: string; created_at: string; mail_from_enabled: boolean; status: 'pending' | 'verified' | 'failed'; type: 'email' | 'domain'; value: string; mail_from_subdomain?: string; verification_records?: { name: string; status: 'pending' | 'verified' | 'failed'; type: 'TXT' | 'CNAME' | 'MX'; value: string; priority?: number; }[]; }",
    "perLanguage": {
      "typescript": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/email/identities \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"type\": \"email\",\n          \"value\": \"dev@stainless.com\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Retrieves a paginated list of sender identities (email addresses and domains) configured for this website.",
  ...
  },
  {
    ...
    "description": "Retrieves a sender identity by ID. Returns the identity with its current verification status and any required DNS records.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/email/identities/$IDENTITY_ID \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Triggers a manual recheck of the identity's verification status against AWS SES. Returns the identity with its updated status.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/email/identities/$IDENTITY_ID/verify \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "description": "Permanently deletes a sender identity. Emails can no longer be sent from this address or domain after deletion.",
  ...
  },
  {
    ...
    "httpMethod": "get",
    "summary": "List Files",
    "description": "Retrieves a paginated list of files uploaded to the website. Supports filtering by MIME type, folder path, creation date, and filename search.",
    ...
    "response": "{ id: string; created: string; filename: string; mime_type: string; size: number; updated: string; url: string; content_hash?: string; metadata?: object; path?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/files \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/files/$FILE_ID \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Enables push notifications for the app by generating VAPID keys. Idempotent - returns existing keys if already enabled. Hercules recommends calling this during app initialization.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/push-notifications/enable \\\n    -X POST \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Registers a push subscription with the provided visitorId. Use authenticated userId or generate a UUID for anonymous users. Upserts by endpoint to handle re-subscriptions. Returns a secret for subscription ownership.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/push-notifications/subscribe \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"subscription\": {\n            \"endpoint\": \"https://example.com\",\n            \"keys\": {\n              \"auth\": \"auth\",\n              \"p256dh\": \"p256dh\"\n            }\n          },\n          \"visitorId\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/push-notifications/unsubscribe \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"secret\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Updates a subscription's visitorId to the provided userId. Call after sign-in to link the subscription to the authenticated user's account.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/push-notifications/identify \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"secret\": \"x\",\n          \"userId\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Sends push notifications to specified visitors and/or topics. Specify visitorIds, topics, or both (combined as union). Omit both to broadcast to all subscribers.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/push-notifications/send \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"title\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Subscribes a visitor to topics. Topics are per-visitor, so all devices for this visitor will receive notifications sent to these topics.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/push-notifications/topics/subscribe \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"topics\": [\n            \"x\"\n          ],\n          \"visitorId\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/push-notifications/topics/unsubscribe \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\" \\\n    -d '{\n          \"topics\": [\n            \"x\"\n          ],\n          \"visitorId\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.hercules.app/v1/push-notifications/topics \\\n    -H \"Authorization: Bearer $HERCULES_API_KEY\""
      }
    }
  }
];
