...
export class Features extends APIResource {
   ...
   * for await (const feature of client.commerce.products.features.list(
   *   'product_id',
   * )) {
   *   // ...
   * }
   ...
   * ```ts
   * const feature =
   *   await client.commerce.products.features.attach(
   *     'product_id',
   ...
   * @example
   * ```ts
   * await client.commerce.products.features.remove(
   *   'feature_id',
