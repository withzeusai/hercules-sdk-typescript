...
export class Coupons extends APIResource {
  ...
  create(body: CouponCreateParams, options?: RequestOptions): APIPromise<Coupon> {
    return this._client.post('/subscriptions/v1/coupons', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/subscriptions/v1/coupons/${couponID}`, { body, ...options });
  }
  ...
  list(
    ...
    return this._client.getAPIList('/subscriptions/v1/coupons', CursorIDPage<Coupon>, { query, ...options });
  }
  ...
  delete(couponID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/subscriptions/v1/coupons/${couponID}`, {
      ...options,
  ...
  get(couponID: string, options?: RequestOptions): APIPromise<Coupon> {
    return this._client.get(path`/subscriptions/v1/coupons/${couponID}`, options);
  }
  ...
  validate(body: CouponValidateParams, options?: RequestOptions): APIPromise<CouponValidateResponse> {
    return this._client.post('/subscriptions/v1/coupons/validate', { body, ...options });
  }
}
