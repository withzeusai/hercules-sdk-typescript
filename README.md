...
```sh
npm install git+ssh://git@github.com:withzeusai/hercules-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/withzeusai/hercules-typescript/issues) with questions, bugs, or suggestions.
