...
describe('resource releases', () => {
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.content.releases.list({
  ...
  test.skip('schedule: only required params', async () => {
    const responsePromise = client.content.releases.schedule('release_id', { scheduled_at: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('schedule: required and optional params', async () => {
    const response = await client.content.releases.schedule('release_id', { scheduled_at: '2019-12-27T18:11:19.117Z' });
  });
});
