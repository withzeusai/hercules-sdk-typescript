...
describe('resource resources', () => {
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.commerce.products.resources.list('product_id', {
    active: true,
  ...
  test.skip('attach: only required params', async () => {
    const responsePromise = client.commerce.products.resources.attach('product_id', { resource_ids: ['string'] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('detach: only required params', async () => {
    const responsePromise = client.commerce.products.resources.detach('product_id', { resource_ids: ['string'] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('detach: required and optional params', async () => {
    const response = await client.commerce.products.resources.detach('product_id', { resource_ids: ['string'] });
  });
});
