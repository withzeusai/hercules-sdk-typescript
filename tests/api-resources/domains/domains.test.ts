...
describe('resource domains', () => {
  ...
  test.skip('checkAvailability: only required params', async () => {
    const responsePromise = client.domains.checkAvailability({ domains: ['string'] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('search: only required params', async () => {
    const responsePromise = client.domains.search({ keyword: 'x' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('search: required and optional params', async () => {
    const response = await client.domains.search({ keyword: 'x', tld_filter: ['string'] });
  });
});
